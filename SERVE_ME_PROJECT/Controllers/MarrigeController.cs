...
{
    public class MarrigeController : CatalogControllerBase
    {
        private const string CatalogControllerName = "Marrige";

        public MarrigeController(ServeMeContext context, UserManager<ApplicationUser> userManager)
        ...
        [HttpGet]
        [AllowAnonymous]
        public IActionResult Services(int categoryId = 45, int page = 1)
        {
